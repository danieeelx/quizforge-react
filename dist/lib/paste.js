...
export function questionNumbersFromText(text) {
    const found = text
        .replace(/\r/g, "")
        .split("\n")
...
export function normalizeSeparateAnswers(answerText, questionText) {
...
export function combinePastedQuestionsAndAnswers(questionText, answerText) {
